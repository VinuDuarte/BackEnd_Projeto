...
public class User implements UserDetails, Serializable {
    ...
    private Boolean accountNonExpiredLocked;
    @Column(name = "credentials_non_expired")
    private Boolean credentialsNonExpired;
    @Column(name = "enabled")
    private Boolean enabled;

    //MAPEANDOA TABELA DE Many to Many
    ...
    public boolean isAccountNonLocked() {
        return this.accountNonExpiredLocked;
    }
    ...
    public Boolean getAccountNonExpiredLocked() {
        return accountNonExpiredLocked;
    }

    public void setAccountNonExpiredLocked(Boolean accountNonExpiredLocked) {
        this.accountNonExpiredLocked = accountNonExpiredLocked;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!Objects.equals(accountNonExpired, user.accountNonExpired))
            return false;
        if (!Objects.equals(accountNonExpiredLocked, user.accountNonExpiredLocked))
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (accountNonExpiredLocked != null ? accountNonExpiredLocked.hashCode() : 0);
